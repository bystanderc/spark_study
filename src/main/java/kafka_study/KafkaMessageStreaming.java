...
//        props.setProperty("bootstrap.servers", "192.168.1.7:9092,192.168.1.7:9093,192.168.1.7:9094");
//        props.setProperty("group.id", "flink-group");
//
//        //    args[0] = "test-0921";  //传入的是kafka中的topic
//        FlinkKafkaConsumer010<String> consumer =
//                new FlinkKafkaConsumer010<>("partopic", new SimpleStringSchema(), props);
...
//        keyedStream.writeAsText("./KafkaFlinkTest");
